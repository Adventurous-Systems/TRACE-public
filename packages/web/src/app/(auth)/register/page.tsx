        ...
        <Card className="trace-self-hosted-only">
          <CardHeader>
            ...
            <p className="trace-public-buyer-demo-only rounded-md border border-sky-200 bg-sky-50 p-3 text-sm text-sky-950">
              An account lets you make an offer on a listing and track it under Orders. This
              retained public demo does not send verification or password-recovery email. Use a
